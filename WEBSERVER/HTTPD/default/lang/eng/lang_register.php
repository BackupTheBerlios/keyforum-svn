...
$lang['reg_nicknotvalid']  = "<br>Invalid username lenght  (min 3, max 30).\n";
$lang['reg_passnotvalid'] = "<br>Invalid password lenght  (min 3, max 30).\n";
...
$lang['reg_info3'] = "To regester a new user, insert only username and password</b>";
