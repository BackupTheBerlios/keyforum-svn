...
<br>
<input type="text" name="helpbox" size="40" maxlength="100" style="width:558px; font-size:10px" class="helpline" value="Info: selezionando il testo potrai applicare velocemente i BBcode" />