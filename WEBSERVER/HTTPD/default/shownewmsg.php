...
if($_REQUEST['allread'])
 ...
 $std->Redirect($lang['shnwmsg_allread'],"index.php",$lang['shnwmsg_markedread'],$lang['shnwmsg_at'].date("d/m/Y H:i:s",$_REQUEST['allread'])); //GLUP MODIFICA QUI :D, gulp-->lollone
 }
