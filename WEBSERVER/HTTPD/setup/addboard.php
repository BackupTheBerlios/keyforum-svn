...
$db->query("CREATE TABLE `{$bsess}_congi` (
  ...
  `AUTORE` binary(16) NOT NULL COMMENT 'AUTHOR',
  PRIMARY KEY  (`ID`),
...
$db->query("CREATE TABLE `{$bsess}_membri` (
  `HASH` binary(16) NOT NULL,
  `AUTORE` varchar(30) NOT NULL default ''  COMMENT 'AUTHOR',
  `DATE` int(10) unsigned NOT NULL,
  `AUTH` tinyblob NOT NULL,
  `SIGN` tinyblob NOT NULL,
  `is_auth` enum('0','1') NOT NULL default '0',
  `firma` text NOT NULL  COMMENT 'SIGNATURE',
  `avatar` blob NOT NULL,
  `title` varchar(100) NOT NULL default '',
  `email` varchar(100) NOT NULL default '',
  `nascita` varchar(20) NOT NULL default ''  COMMENT 'BIRTH DAY',
  `provenienza` varchar(70) NOT NULL default ''  COMMENT 'FROM',
...
$db->query("CREATE TABLE `{$bsess}_newmsg` (
  ...
  `visibile` enum('0','1') NOT NULL default '1'  COMMENT 'VISIBLE',
...
$db->query("CREATE TABLE `{$bsess}_permessi` (
  `AUTORE` binary(16) NOT NULL  COMMENT 'AUTHOR',
  `DATE` int(10) unsigned NOT NULL,
  `CHIAVE_A` varchar(100) NOT NULL  COMMENT 'A KEY',
  `CHIAVE_B` varchar(100) NOT NULL  COMMENT 'B KEY',
  `VALORE` text NOT NULL  COMMENT 'VALUE',
...
$db->query("CREATE TABLE `{$bsess}_sez` (
  ...
  `ORDINE` int(10) unsigned NOT NULL default '0'  COMMENT 'POSITION',
  `FIGLIO` int(10) unsigned NOT NULL default '0'  COMMENT 'PARENT ID (SON OF)',
